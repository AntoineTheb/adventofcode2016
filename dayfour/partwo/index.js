  ...
  for (let i = 0; i < potentialRooms.length; ++i) {
    ...
    for(let j = 0; j < room[0].length; ++j) {
      if (room[0][j] === '-') {
        ...
        let letter = room[0].charCodeAt(j) - 97;
        letter = (letter + parseInt(room[1])) % 26;
        roomName += String.fromCharCode(letter + 97);
      }
    }
    console.log(roomName, room[1]);
  }
}
